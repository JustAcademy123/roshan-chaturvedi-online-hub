...
import { ExternalLink, Linkedin, Twitter, Mail, Heart } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://linkedin.com/in/roshan-chaturvedi" 
              ...
              <a 
                href="https://twitter.com/roshan_chaturvedi" 
                className="text-muted-foreground hover:text-primary transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a 
                href="mailto:hello@roshanchaturvedi.com" 
                className="text-muted-foreground hover:text-primary transition-colors"
              >
