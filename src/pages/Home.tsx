...
const Home = () => {
  ...
  const featuredArticle = {
    ...
    excerpt: "An in-depth analysis of how educational technology is breaking down barriers and making quality education accessible worldwide.",
      ...
      <section className="py-20 bg-gradient-hero text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
            Whether you're an educator, entrepreneur, or innovator, I'd love to connect and explore 
            how we can collaborate to make learning more accessible and effective.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
